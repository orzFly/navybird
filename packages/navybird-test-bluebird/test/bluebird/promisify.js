...
describe("when calling promisified function it should ", function () {
  specify("return a promise that is pending", async function () {
    var a = error(1, 2, 3).inspectable();
    var b = success(1, 2, 3).inspectable();
    var c = successMulti(1, 2, 3).inspectable();
